...
SVC_NAME="actions.runner.Rath0ure-company-automation.ip-192-168-3-171"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (Rath0ure-company-automation.ip-192-168-3-171)"
